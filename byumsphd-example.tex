\documentclass[phd,electronic,letterpaper,chaptercenter,parttop]{byumsphd}
% Author: Chris Monson
%
...
%   ms -- produce a thesis
%
%   electronic -- default convenience option, sets the following options:
%                 - no signaturepage
%                 - equalmargins
%                 - oneside
%   hardcopy -- convenience options, sets the following options:
%                 - signaturepage
%                 - no equalmargins
%                 - twoside
%
