...
% If you want dot leaders on all TOC entries, you can do the following (example
% covers chapters, there are similar settings for other headings: run "texdoc
% tocloft" for more information).
%\usepackage{tocloft}
