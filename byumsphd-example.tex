...
% NOTE: If you use natbib, then you are in luck.  There is a neat little hack I
% cooked up to get "References" to show up in your TOC (I hate it, so I don't
% use it, but Dan Delorey apparently needed to) and to bookmark correctly.
% Between \usepackage{natbib} and \begin{document}, put the following lines:
%
