\documentclass[letterpaper,phd,chaptercenter,parttop,lot,lof,lol,signaturepage,twoside]{byumsphd}
% Author: Chris Monson
%
...
%
%   signaturepage -- include a signature page in the front matter (typically
%     only used for a bound hardcopy, since signatures won't show up in the
%     electronic version for obvious reasons)
%
...
% EXAMPLES:
%
% To set up the thesis for an electronic copy, you should set the following options:
%
% equalmargins
% oneside (optional - some people like to keep things two-sided so that page numbers don't get messed up - I know I do)
%
% For printing and binding, I suggest you do the following:
%
% Do NOT set equalmargins
% twoside
% signaturepage
%
% The rest is up to you.  To fiddle with margins, use the \settextwidth and \setbindingoffset macros, described below.
...
%
% NOTE: if you use pdftex instead of latex + dvips + ps2pdf, then you need to
% change the corresponding entry below (ps2pdf -> pdftex).  If you use my LaTeX
% makefile (at http://latex-makefile.googlecode.com/) then ps2pdf is the right
% way to go.  There are many other benefits to using the makefile, too.
\usepackage[
    ps2pdf,
    bookmarks=true,
...
% directly at your peril.  It's best just to use the above macros to manipulate your margins.
%
% That said, using the geometry macro to set top and bottom margins, or anything else vertical, is perfectly safe and encouraged, e.g.,
%
